...
export class HostNotificationsComponent implements OnInit {
  notifications: Notification[] = [];  // Definišemo svojstvo notifications
  constructor(private http: HttpClient, private router: Router) {}  // Definišemo svojstvo http u konstruktoru
  ...
  loadNotifications(): void {
    ...
    if (token) {
      ...
      // Ovo je HTTP zahtev za preuzimanje notifikacija
